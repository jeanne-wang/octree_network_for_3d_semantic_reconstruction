#ifndef CAFFE_PRIMAL_DUAL_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_PRIMAL_DUAL_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
class PrimalDualCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
   
  explicit PrimalDualCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "PrimalDualCrossEntropyLoss"; }
