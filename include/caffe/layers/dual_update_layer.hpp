#ifndef CAFFE_DUAL_UPDATE_LAYER_HPP_
#define CAFFE_DUAL_UPDATE_LAYER_HPP_
...
class DualUpdateLayer : public Layer<Dtype> {
 public:
  explicit DualUpdateLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DualUpdate"; }
 ...
 protected:
  ...
  shared_ptr<DualProjectionLayer<Dtype> > dual_projection_layer_;
...
#endif  // CAFFE_DUAL_UPDATE_LAYER_HPP_
