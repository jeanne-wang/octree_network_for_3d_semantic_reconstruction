#ifndef CAFFE_OCT_SEG_ACCURACY_LAYER_HPP_
#define CAFFE_OCT_SEG_ACCURACY_LAYER_HPP_
...
class OctSegAccuracyLayer : public Layer<Dtype> {
 public:
 
  explicit OctSegAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "OctSegAccuracy"; }
...
#endif  // CAFFE_OCT_SEG_ACCURACY_LAYER_HPP_
