...
def create_model(batch_size, num_classes, test_data_list_file, test_groundtruth_list_file, preload_data, 
    ...
    model.name = 'prop_pred_levels_{}_iters_{}_{}_{}'.format(nlevels, niter_l0, niter_l1, niter_l2)
    layers = []
    ...
    if test_groundtruth_list_file != None:
        layers.append(OctInput('input_gt', 'gt', batch_size, test_groundtruth_list_file, num_classes, preload_data))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_groundtruth_list_file", type=str)
