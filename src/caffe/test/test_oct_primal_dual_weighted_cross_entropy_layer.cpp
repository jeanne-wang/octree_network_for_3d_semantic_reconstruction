...
class OctPrimalDualWeightedLossLayerTest : public MultiDeviceTest<TypeParam> {
  typedef typename TypeParam::Dtype Dtype;

 protected:
  OctPrimalDualWeightedLossLayerTest()
  ...
  virtual ~OctPrimalDualWeightedLossLayerTest() {
...
TYPED_TEST_CASE(OctPrimalDualWeightedLossLayerTest, TestDtypesAndDevices);

TYPED_TEST(OctPrimalDualWeightedLossLayerTest, TestLoss) {
  typedef typename TypeParam::Dtype Dtype;
  ...
  OctPrimalDualWeightedCrossEntropyLossLayer<Dtype> layer(layer_param);
