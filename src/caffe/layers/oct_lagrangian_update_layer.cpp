...
void OctLagrangianUpdateLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void OctLagrangianUpdateLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void OctLagrangianUpdateLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void OctLagrangianUpdateLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(OctLagrangianUpdateLayer);
#endif

INSTANTIATE_CLASS(OctLagrangianUpdateLayer);
REGISTER_LAYER_CLASS(OctLagrangianUpdate);
