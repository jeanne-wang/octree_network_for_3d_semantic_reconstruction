...
void OctPrimalFurtherUpdateLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void OctPrimalFurtherUpdateLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void OctPrimalFurtherUpdateLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(OctPrimalFurtherUpdateLayer);
#endif

INSTANTIATE_CLASS(OctPrimalFurtherUpdateLayer);
REGISTER_LAYER_CLASS(OctPrimalFurtherUpdate);
