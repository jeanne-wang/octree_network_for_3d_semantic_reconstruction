...
def create_model(batch_size, num_classes, test_data_list_file, test_groundtruth_list_file, preload_data, 
    ...
    # layers.append(Silence('output_silence', 'pred'))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--niter_l0", type=int, default=1)
    parser.add_argument("--niter_l1", type=int, default=1)
    parser.add_argument("--niter_l2", type=int, default=1)
